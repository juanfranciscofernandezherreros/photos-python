"""Paginated global photo feed endpoint."""
...
def get_photos(
    ...
    """Return a global page ordered by effective capture day descending."""
    selected, total = repo.load_photos_page(offset, limit, favourite)
    photos: list[dict] = []
    ...
    for candidate in selected:
        ...
        photos.append({
            ...
            "exists": exists,
            "url": f"/api/photo?path={quote(file_path, safe='')}",
        })
